  ...
  useEffect(() => {
    ...
    const registerPlayer = async () => {
      try {
        ...
        const playerName = await OBR.player.name
        const playerColor = await OBR.player.color
        const playerRole = await OBR.player.role
        ...
        // Mettre à jour ou ajouter ce joueur seulement
